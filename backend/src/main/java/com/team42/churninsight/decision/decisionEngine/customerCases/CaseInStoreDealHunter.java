...
public class CaseInStoreDealHunter {
    ...
    public static class HighChurnPromoAbuse implements DecisionRule {
        ...
        public List<String> getActions() {
            return List.of("Invitación a eventos en tienda + cashback en lugar de descuentos");
        }
    }
    public static class NoRisk implements DecisionRule {
        ...
        @Override
        public List<String> getActions() {
            return List.of("Programa de lealtad en tienda + descuentos escalonados por visitas");
        }
    }
}
